<style>
    ...
    <source src="<?=base_url();?>assets/images/video/Cyber security.mp4" type="video/mp4">
     </video>
    ...
    <div class="products-section container pt-5">
        <div class="about-heading">
            <h3 class="text-center text-theme pt-2 pb-1">
               Protecting Your Digital Assets with Robust Security Solutions Since 2019
            </h3>
        </div>
        <p>
       At KloudBricks, we believe that in a world driven by technology, security is not just an option — it’s a necessity. Since 2019, our Cybersecurity Services have been helping businesses safeguard their digital assets, data, systems, and customer trust from growing cyber threats.
        </p>
        <p>
         As cyberattacks become more sophisticated, businesses need proactive, reliable, and comprehensive security measures to stay protected. Our cybersecurity services are designed to ensure that your business operates securely, confidently, and without interruptions
        </p>
    </div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 pe-5 ">
                        <h3 data-aos="fade-down-right" data-aos-duration="2500"
                            ...
                            What We Offer Through Our <p class="pt-1 m-0" style="color: #1d54ac;">Cybersecurity Services
                            </p>
                        </h3>
                        <ul class="key-points">
                            <li data-aos="fade-down-right">
                          <b> Risk Assessment & Security Audits: </b> Identify vulnerabilities, risks, and weaknesses in your current systems with comprehensive assessments and security audits.
                            </li>
                            <li data-aos="fade-down-right">
                               <b>Threat Detection & Prevention:</b> Proactive monitoring and defense mechanisms to detect and block cyber threats, malware, phishing attacks, and ransomware.
                            </li>
                            <li data-aos="fade-down-right">
                                <b> Network & Infrastructure Security:</b> Protect your network, servers, and IT infrastructure from unauthorized access, intrusions, and cyberattacks.
                            </li>
                            <li data-aos="fade-down-right">
                               <b>Application Security:</b> Ensure that your web and mobile applications are secure from vulnerabilities, data leaks, and malicious attacks.
                            </li>

                            <li data-aos="fade-down-right">
                           <b> Data Protection & Encryption:</b> Safeguard sensitive information with strong encryption, secure data storage, and controlled access.
                            </li>
                            <li data-aos="fade-down-right">
                         <b> Cloud Security:</b> Ensure your cloud-hosted data, apps, and services are secure with advanced cloud security strategies and controls.
                            </li>
                            <li data-aos="fade-down-right">
                         <b>  Disaster Recovery & Incident Response:</b> Rapid response strategies for cyber incidents, along with backup and recovery solutions to minimize damage and downtime.
                            </li>
                            <li data-aos="fade-down-right">
                               <b> Compliance & Regulatory Support:</b> Stay compliant with global data security standards and regulations such as GDPR, HIPAA, PCI-DSS, and more.
                            </li>
                            <li data-aos="fade-down-right">
                                <b>Employee Security Training:</b> Empower your teams with cybersecurity awareness training to reduce risks caused by human errors and social engineering attacks.
                            </li>
                    ...
                    <div class="col-lg-6 pt-5">
                        <img class="services-img" data-aos="fade-down-left" data-aos-duration="2500"
                            src="<?=base_url();?>assets/images/services/cybersecurity.png" alt="Cybersecurity Services">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="industries-section" style="background-color: #f7fafe;">
        ...
        <div class="container pt-5">
            <div class="about-heading">
                ...
                <h3 class="text-center text-theme pt-0 pb-3" data-aos="fade-down" data-aos-duration="1300"> Our Cybersecurity Solutions </h3>
            </div>

            <div class="why-kb">
                <ul class="whychoose-kb" style="list-style: none;">
                    <li data-aos="fade-up" data-aos-duration="1000"> <span class="dot"></span>&nbsp; <b>Trusted Since 2019:</b> With over 5 years of experience, we have been a trusted partner in protecting businesses from evolving cyber threats.</li>

                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                   <b> Proactive Security Approach:</b> We don’t wait for attacks to happen. Our proactive defense strategies detect and prevent risks before they impact your business.
                    </li>

                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                  <b> End-to-End Protection:</b> From networks and applications to data and cloud — we offer comprehensive protection across every aspect of your digital ecosystem.
                    </li>

                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                    <b>Business Continuity Focus:</b> We ensure that your operations remain uninterrupted, your data stays safe, and your reputation stays intact — even in the face of cyber threats.
                    </li>
                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                 <b>Customized Security Solutions:</b> Every business is unique. Our cybersecurity solutions are tailored to fit your needs, risks, and operational requirements.
                    </li>
                     <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                   <b>Expert Response Team:</b> A dedicated team of cybersecurity experts ready to act swiftly in case of any incident, minimizing damage and downtime.
                    </li>
    ...
    <div class="container pt-5">
        <div class="about-heading">
            <h3 class="text-center " data-aos="fade-down" data-aos-duration="1000">Industries We Safeguard With</h3>
            <h3 class="text-center text-theme pt-0 pb-3" data-aos="fade-down" data-aos-duration="1300"> Cybersecurity Solutions
            </h3>
        </div>
    ...
    <div class="outcome-business" style="background-color: #F4F4F4;">
        <div class="container py-5">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-5">
                    <img data-aos="fade-right" src="<?=base_url();?>assets/images/services/cyber-security-services.png"
                ...
                <div class="col-lg-6">
                    ...
                    <div class="why-kb">
                        <ul class="whychoose-kb" style="list-style: none;">
                            <li data-aos="fade-down"> <span class="dot"></span>&nbsp;Peace of mind knowing your data is safe
                            </li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp;Reduced risk of cyberattacks, breaches, and fraud</li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp; Stronger trust with your customers and stakeholders
                            </li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp;Compliance with data protection regulations
                            </li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp;Uninterrupted business operations</li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp; Protection of brand reputation and customer confidence
                            </li>
                        </ul>
    ...
    <div class="container py-5">
        <div class="about-heading">
            <h3 class="text-center " data-aos="fade-down" data-aos-duration="1000">Security Your Business Future  </h3>
            <h3 class="text-center text-theme  pb-3" data-aos="fade-down" data-aos-duration="1300">With KloudBricks</h3>
            <p class="text-center">
        At KloudBricks, we don’t just protect your business — we empower it to grow with confidence. Our cybersecurity solutions safeguard your digital assets, customer data, and business integrity, ensuring that you stay resilient in an increasingly connected and risky digital world.
            </p>
            <p class="text-center">
           Partner with us for intelligent, comprehensive, and proactive cybersecurity solutions. Because when your business is secure, your growth is unstoppable.
            </p>
    ...
    <section class="tech-section py-5" style="background: #f5f8fd;">
        <div class="container">
            <div class="about-heading">
                <h3 class="text-center " data-aos="fade-down" data-aos-duration="1000"> Cybersecurity  </h3>
    ...
    <div class="development-excellence pt-3" style="background-color: #1D54AC;">
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7">
                    <h3 class="text-white fs-2 pb-3">Cybersecurity  Excellence at Kloudbricks</h3>
                    <p class="text-white fs-5">Empowering businesses with proactive defenses and threat intelligence to protect digital assets confidently and compliantl.</p>
                    <a href="#" class="know-more mt-5">Know More</a>
                </div>
                <div class="col-lg-4 px-5">
                    <img src="<?=base_url();?>assets/images/services/cybersecurity-excellence.png" alt="Cybersecurity Excellence">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="timeline-container era-early-web" id="timelineContainer">
        ...
        <div class="about-heading">
            ...
            <h3 class="text-center text-theme pt-0" data-aos="fade-down" data-aos-duration="1300">Cybersecurity    Services Methodology
            </h3>
            <p class="text-center pb-4">Worried about security gaps? Let’s safeguard your digital assets — talk to us below.</p>
        </div>
