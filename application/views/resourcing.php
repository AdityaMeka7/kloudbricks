<style>
    ...
    <source src="<?=base_url();?>assets/images/video/Resourcing.mp4" type="video/mp4">
    </video>
    ...
    <div class="products-section container pt-5">
        <div class="about-heading">
            <h3 class="text-center text-theme pt-2 pb-1">
                Keeping Your Digital Solutions Running Smoothly Since 2019
            </h3>
        </div>
        <p>
           At KloudBricks, we believe that delivering a great product is just the beginning — maintaining it is what ensures long-term success. Since 2019, our Support & Maintenance Services have been helping businesses keep their applications, websites, and digital platforms running seamlessly, securely, and efficiently. Technology is constantly evolving, and businesses need their digital assets to be up-to-date, error-free, and fully optimized. Our reliable support ensures that your systems continue to perform at their best — so you can focus on growth while we handle the rest. </p>
    </div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 pe-5 ">
                        <h3 data-aos="fade-down-right" data-aos-duration="2500"
                            ...
                            What We Offer Through Our <p class="pt-1 m-0" style="color: #1d54ac;">Our Support & Maintenance Services </p>
                        </h3>
                        <ul class="key-points">
                            <li data-aos="fade-down-right">
                               <b> Ongoing Performance Monitoring:</b> We continuously monitor your applications to ensure optimal performance, identifying and resolving issues before they impact users.
                            </li>
                            <li data-aos="fade-down-right">
                             <b> Timely Bug Fixes:</b> Our team swiftly addresses any technical glitches, errors, or issues — minimizing downtime and maintaining user satisfaction
                            </li>
                            <li data-aos="fade-down-right">
                             <b>  Regular Updates & Enhancements:</b> We keep your systems up-to-date with the latest features, improvements, and optimizations — helping your business stay competitive.
                            </li>
                            <li data-aos="fade-down-right">
                               <b> Security & Compliance Checks:</b> We ensure your applications stay protected against emerging threats with regular security patches, updates, and compliance checks.
                            </li>

                            <li data-aos="fade-down-right">
                               <b>Scalability Support:</b> As your user base grows, we help scale your infrastructure and optimize performance to handle increasing demand smoothly.
                            </li>
                            <li data-aos="fade-down-right">
                               <b>Backup & Disaster Recovery:</b> We implement regular backups and reliable recovery plans, ensuring your data and applications are safe from unexpected failures.
                            </li>
                            <li data-aos="fade-down-right">
                            ...
                            <li data-aos="fade-down-right">
                               <b>Version Upgrades:</b> We assist in upgrading platforms, libraries, and frameworks, ensuring your application remains compatible with evolving technologies.
                            </li>
                             <li data-aos="fade-down-right">
                               <b>Technical Support:</b> Round-the-clock support to assist your team with queries, troubleshooting, and quick resolutions — ensuring business continuity.
                            </li>
                    ...
                    <div class="col-lg-6 pt-5">
                        <img class="services-img" data-aos="fade-down-left" data-aos-duration="2500"
                            src="<?=base_url();?>assets/images/services/support-maintenance.png" alt="support-maintenance">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="industries-section" style="background-color: #f7fafe;">
        ...
        <div class="container pt-5">
            <div class="about-heading">
                ...
                <h3 class="text-center text-theme pt-0 pb-3" data-aos="fade-down" data-aos-duration="1300"> Support & Maintenance</h3>
            </div>

            <div class="why-kb">
                <ul class="whychoose-kb" style="list-style: none;">
                    <li data-aos="fade-up" data-aos-duration="1000"> <span class="dot"></span>&nbsp;Reliable Partner Since 2019: With over 5 years of experience, we’ve earned the trust of businesses by ensuring their digital solutions are always stable, secure, and performing.</li>

                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                     Proactive Approach: We don’t wait for problems to happen. Our proactive monitoring and preventive maintenance help avoid issues before they affect your business.</li>

                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                       Business Continuity Focus: We ensure that your applications remain operational, efficient, and uninterrupted — minimizing downtime and maximizing productivity.</li>

                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                     Cost-Effective Solutions: Avoid the high costs of emergency fixes or breakdowns with our planned, affordable, and efficient maintenance packages.
                    </li>
                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;
                    Dedicated Support Team: Our responsive, experienced, and dependable support team is always ready to assist — providing peace of mind for your business. </li>

                    <li class="pt-2" data-aos="fade-down" data-aos-duration="1000"> <span class="dot"></span>&nbsp;Flexible Engagement Models: From ongoing monthly support to on-demand assistance or dedicated support resources — we offer models that suit your needs.
                    </li>
    ...
    <div class="container pt-5">
        <div class="about-heading">
            <h3 class="text-center " data-aos="fade-down" data-aos-duration="1000">Who We Support</h3>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="CaRd">
                    <img class="IMG" src="<?=base_url();?>assets/images/services/support-1.png" alt="services-img">
                    <div class="intro">
                        <h1 class="text-h1">Websites & <br> Web Applications </h1>
                        <div class="text pt-2">
                            <div class="service-content1">
                                <img style="width: 50px;" src="<?=base_url();?>assets/images/services/game-icon1.png" alt="">
                                <h4 class="text-white"> Websites & Web Applications</h4>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="CaRd">
                    <img class="IMG" src="<?=base_url();?>assets/images/services/support-2.png" alt="services-img">
                    <div class="intro">
                        <h1 class="text-h1">Mobile Applications <br> (iOS/Android)</h1>
                        <div class="text pt-2">
                            <div class="service-content1">
                                <img style="width: 50px;" src="<?=base_url();?>assets/images/services/game-icon2.png" alt="">
                                <h4 class="text-white"> Mobile Applications <br> (iOS/Android)</h4>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="CaRd">
                    <img class="IMG" src="<?=base_url();?>assets/images/services/support-3.png" alt="services-img">
                    <div class="intro">
                        <h1 class="text-h1">SaaS Products <br> & Platforms </h1>
                        <div class="text pt-2">
                            <div class="service-content1">
                                <img style="width: 50px;" src="<?=base_url();?>assets/images/services/game-icon3.png" alt="icon">
                                <h4 class="text-white"> SaaS Products & Platforms</h4>
                                <p> SaaS Products and Platforms provide scalable, subscription-based solutions that enhance collaboration, streamline workflows, and drive innovation across industries</p>
                            </div>
                            <div class="d-flex justify-content-center align-items-center">
                                <a href="#" class="btn btn-light"> <i class="fa fa-arrow-circle-right"
                                        aria-hidden="true"></i> &nbsp; Learn More</a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="CaRd">
                    <img class="IMG" src="<?=base_url();?>assets/images/services/support-4.png" alt="services-img">
                    <div class="intro">
                        <h1 class="text-h1">E-commerce <br> Stores </h1>
                        <div class="text pt-2">
                            <div class="service-content1">
                                <img style="width: 50px;" src="<?=base_url();?>assets/images/services/game-icon4.png" alt="icon">
                                <h4 class="text-white"> E-commerce Stores</h4>
                                <p> E-commerce Stores focus on creating seamless online shopping experiences, integrating payment gateways, and optimizing product catalogs for increased sales</p>
                            </div>
                            <div class="d-flex justify-content-center align-items-center">
                                <a href="#" class="btn btn-light"> <i class="fa fa-arrow-circle-right"
                                        aria-hidden="true"></i> &nbsp; Learn More</a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="CaRd">
                    <img class="IMG" src="<?=base_url();?>assets/images/services/support-5.png" alt="services-img">
                    <div class="intro">
                        <h1 class="text-h1">Enterprise Solutions & Internal Systems </h1>
                        <div class="text pt-2">
                            <div class="service-content1">
                                <img style="width: 60px;" src="<?=base_url();?>assets/images/services/game-icon5.png" alt="icon">
                                <h4 class="text-white">Enterprise Solutions & Internal Systems</h4>
                                <p>Enterprise Solutions and Internal Systems focus on optimizing business processes, enhancing collaboration, and improving overall efficiency through tailored software solutions</p>
                            </div>
                            <div class="d-flex justify-content-center align-items-center">
                                <a href="#" class="btn btn-light"> <i class="fa fa-arrow-circle-right"
                                        aria-hidden="true"></i> &nbsp; Learn More</a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="CaRd">
                    <img class="IMG" src="<?=base_url();?>assets/images/services/support-6.png" alt="services-img">
                    <div class="intro">
                        <h1 class="text-h1">AR/VR &  <br> Gaming Applications</h1>
                        <div class="text pt-2">
                            <div class="service-content1">
                                <img style="width: 50px;" src="<?=base_url();?>assets/images/services/game-icon6.png" alt="icon">
                                <h4 class="text-white">AR/VR & Gaming Applications</h4>
                                <p>AR/VR and Gaming Applications leverage cutting-edge technologies to create immersive experiences that engage users and transform interactions</p>
                            </div>
                            <div class="d-flex justify-content-center align-items-center">
                                <a href="#" class="btn btn-light"> <i class="fa fa-arrow-circle-right"
                                        aria-hidden="true"></i> &nbsp; Learn More</a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="CaRd">
                    <img class="IMG" src="<?=base_url();?>assets/images/services/support-7.png" alt="services-img">
                    <div class="intro">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="CaRd">
                    <img class="IMG" src="<?=base_url();?>assets/images/services/support-8.png" alt="services-img">
                    <div class="intro">
    ...
    <div class="outcome-business" style="background-color: #F4F4F4;">
        <div class="container py-5">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <h3 class="text-center">What You Achieve with Kloudbricks <p style="color: #1d54ac;" class="pt-1">  Support Services </p>
                    </h3>
                    <div class="why-kb">
                        <ul class="whychoose-kb" style="list-style: none;">
                            <li data-aos="fade-down"> <span class="dot"></span>&nbsp;Higher system uptime
                            </li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp;Faster issue resolution </li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp; Improved user satisfaction
                            </li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp;Enhanced security and stability
                            </li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp;Future-proof systems with regular updates</li>
                            <li class="pt-2" data-aos="fade-down"> <span class="dot"></span>&nbsp; Reduced operational risks and costs
                            </li>
                        </ul>
     ...
     <div class="container py-5">
        <div class="about-heading">
            <h3 class="text-center " data-aos="fade-down" data-aos-duration="1000">Focus On Growth</h3>
            <h3 class="text-center text-theme  pb-3" data-aos="fade-down" data-aos-duration="1300">Let Us Handle the Rest</h3>
            <p class="text-center">
                At KloudBricks, we ensure your digital assets stay healthy, secure, and optimized — day in, day out. Our Support & Maintenance services are designed to give you the confidence that your applications will continue performing reliably while you focus on scaling your business.

            </p>
            
            <p class="text-center">
                Partner with us to safeguard your digital investments and ensure business continuity, stability, and growth. We keep things running — you keep moving forward.
            </p>
        </div>
    </div>
    ...
    <section class="tech-section py-5" style="background: #f5f8fd;">
        <div class="container">
            <div class="about-heading">
                <h3 class="text-center " data-aos="fade-down" data-aos-duration="1000">  Resourcing or Staffing </h3>
    ...
    <div class="development-excellence pt-3" style="background-color: #1D54AC;">
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7">
                    <h3 class="text-white fs-2 pb-3">Resourcing App Excellence at Kloudbricks</h3>
                ...
                <div class="col-lg-4 px-5">
                    <img src="<?=base_url();?>assets/images/services/support-excellence.png" alt="support-excellence">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="timeline-container era-early-web" id="timelineContainer">
        ...
        <div class="about-heading">
            ...
            <h3 class="text-center text-theme pt-0" data-aos="fade-down" data-aos-duration="1300">Resourcing & Staffing
                Methodology
            </h3>
            <p class="text-center pb-4">Need the right talent fast? Let’s find skilled professionals for your team — talk to us below.</p>
        </div>
