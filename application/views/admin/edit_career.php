<div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Edit Career</h4>
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input
              ...
              placeholder="Job Title" name="name" required value="<?=$career[0]['name']?>"/>
          </div>
          ...
          <div class="mb-3">
                ...
                <select class="form-select" name="type" id="type" placeholder="Type" required>
                    ...
                    <?php foreach($types as $row){?>
                        <option value="<?=$row['id']?>" <?php if($career[0]['type']==$row['id']){echo 'selected="selected"';}?>><?=$row['name']?></option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="location" id="location" placeholder="Location" required>
                    ...
                    <option value="Remote" <?php if($career[0]['location']=='Remote'){echo 'selected="selected"';}?>>Remote</option>
                    <option value="Onsite" <?php if($career[0]['location']=='Onsite'){echo 'selected="selected"';}?>>Onsite</option>
                </select>
            </div>
          ...
          <div class="mb-3">
            ...
            <input
              ...
              class="form-control"
              id="exampleFormControlInput1"
              placeholder="Openings" name="openings" min="1" required value="<?=$career[0]['openings']?>"/>
          </div>
...
$(document).ready(function () {
    $('#saveBtn').on('click', function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                url: '<?= base_url("dashboard/admin/edit_career_data/".$career[0]['id']); ?>',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
