<div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Edit Job Type</h4>
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input
              ...
              placeholder="Name" name="name" required value="<?=$job_type[0]['name']?>" />
          </div>
...
$(document).ready(function () {
    $('#saveBtn').on('click', function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                url: '<?= base_url("dashboard/admin/edit_job_type_data/".$job_type[0]['id']); ?>',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
