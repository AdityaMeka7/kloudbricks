...
(function () {
  ...
  const lineChartEl = document.querySelector('#lineChart'),
    lineChartConfig = {
      ...
      series: [
        {
          data: [90, 80, 90, 60, 40, 80, 70, 90, 50, 80, 90, 40, 60, 100, 50]
        }
      ],
      markers: {
        strokeWidth: 7,
  ...
  // Horizontal Bar Chart(USED IN DASHBOARD)
  ...
  const horizontalBarChartEl = document.querySelector('#horizontalBarChart'),
    horizontalBarChartConfig = {
      ...
      xaxis: {
        categories: ['MON', 'TEU', 'WED', 'THU', 'FRI', 'SAT', 'SUN'],
        axisBorder: {
          show: false
        },
        axisTicks: {
